...
"""
summer = pd.read_csv("Summer_output.csv", on_bad_lines="skip")
winter = pd.read_csv("Winter_output.csv", on_bad_lines="skip")
...
def get_minimal_cost(season):
    ...
    if season["End date/time"][0] == '30/09/2021 00:00:00':
        emissionlist = EMISSION_CONSTRAINTS_SUMMER
    elif season["End date/time"][0] == '2021-12-31 00:00:00':
